...
namespace TechWayFit.ContentOS.Infrastructure.Persistence.Postgres.Migrations
{
    ...
    [Migration("20260102100117_AddTenantsTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TechWayFit.ContentOS.Infrastructure.Persistence.Postgres.Entities.ContentItemRow", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("TechWayFit.ContentOS.Infrastructure.Persistence.Postgres.Entities.ContentLocalizationRow", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("TechWayFit.ContentOS.Infrastructure.Persistence.Postgres.Entities.TenantRow", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("TechWayFit.ContentOS.Infrastructure.Persistence.Postgres.Entities.WorkflowStateRow", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("TechWayFit.ContentOS.Infrastructure.Persistence.Postgres.Entities.ContentLocalizationRow", b =>
                {
                    b.HasOne("TechWayFit.ContentOS.Infrastructure.Persistence.Postgres.Entities.ContentItemRow", "ContentItem")
