...
/// <summary>
/// EF Core configuration for GroupRow - User groups
/// </summary>
public sealed class GroupConfiguration : IEntityTypeConfiguration<GroupRow>
{
    public void Configure(EntityTypeBuilder<GroupRow> builder)
    {
        ...
        // Indexes
        builder.HasIndex(e => e.TenantId).HasDatabaseName("ix_group_tenant_id");
        builder.HasIndex(e => new { e.TenantId, e.Name })
            .IsUnique()
            .HasFilter("deleted_on IS NULL")
            .HasDatabaseName("uq_group_tenant_name");
    }
}
